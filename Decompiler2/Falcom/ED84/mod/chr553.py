...
def PreInit():
    ...
    AnimeClipCmd(0x0F, 0xFFFE, 0x00)
    AnimeClipCmd(0x0D, 0xFFFE)
    AnimeClipCmd(0x00, 0xFFFE, 'C_CHR011_DF1', 'WAIT')
...
def AniFieldAttack():
    ...
    CameraCmd(0x0A, 0.0, 0.1, 1.0, 0x0000, 0x0064, 0x0000, 0x0000, 0x0000, 0x00)
...
def AniBtlAttack():
    ...
    CameraCmd(0x0A, 0.0, 0.005, 0.25, 0x0000, 0x0190, 0x0000, 0x0000, 0x0000, 0x00)
...
def AniBtlCraft00():
    ...
    OP_3B(0x00, (0xFF, 0x10B1, 0x0), (0xEE, 1.0, 0x0), (0xFF, 0x0, 0x0), 0.0, (0xEE, 1.0, 0x0), 0x0000, 0xFFFF, 0.0, 0.0, 0.0, (0xFF, 0x0, 0x0), '', (0xFF, 0x0, 0x0), (0xFF, 0x0, 0x0), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0.0)
    OP_3B(0x00, (0xFF, 0x8F1C, 0x0), (0xEE, 1.0, 0x0), (0xFF, 0x0, 0x0), 0.0, (0xEE, 1.0, 0x0), 0x0000, 0xFFFF, 0.0, 0.0, 0.0, (0xFF, 0x0, 0x0), '', (0xFF, 0x0, 0x0), (0xFF, 0x0, 0x0), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0.0)
    CameraCmd(0x0A, 0.1, 0.1, 0.01, 0x0064, 0x05DC, 0x04B0, 0x0000, 0x0000, 0x00)
    ...
    EffectCmd(0x14, 0xFFFE, 0x03, 1.0, 1.0, 1.0, 0.0, 0x03E8, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x04, 1.0, 1.0, 1.0, 0.0, 0x03E8, 0x03)
    WaitAnimeClip(0xFFFE, 0.0, 0x00)
...
def AniBtlCraft01():
    ...
    EffectCmd(0x14, 0xFFFE, 0x0C, 0.0, 0.0, 0.0, 0.0, 0x0000, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0C, 1.0, 0.5, 0.3, 0.5, 0x0320, 0x03)
    ...
    EffectCmd(0x14, 0xFFFE, 0x0C, 0.0, 0.0, 0.0, 0.0, 0x0000, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0C, 1.0, 0.5, 0.3, 0.5, 0x012C, 0x03)
    ...
    EffectCmd(0x14, 0xFFFE, 0x0D, 0.0, 0.0, 0.0, 0.0, 0x0000, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0D, 1.0, 0.5, 0.3, 0.5, 0x012C, 0x03)
    ...
    BattleCmd(0x3F, 0xFFFE)
    EffectCmd(0x14, 0xFFFE, 0x0C, 0.0, 0.0, 0.0, 0.0, 0x03E8, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0D, 0.0, 0.0, 0.0, 0.0, 0x03E8, 0x03)
    ...
    EffectCmd(0x14, 0xFFFE, 0x0D, 0.0, 0.0, 0.0, 0.0, 0x0000, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0D, 1.0, 0.5, 0.3, 1.0, 0x012C, 0x03)
    ...
    CameraCmd(0x0A, 0.07, 0.07, 0.01, 0x0064, 0x0064, 0x0064, 0x0000, 0x0000, 0x00)
    OP_3B(0x00, (0xFF, 0x10B1, 0x0), (0xEE, 1.0, 0x0), (0xFF, 0x0, 0x0), 0.0, (0xEE, 0.0, 0x0), 0x0000, 0xFFFF, 0.0, 0.0, 0.0, (0xFF, 0x0, 0x0), '', (0xFF, 0x0, 0x0), (0xFF, 0x0, 0x0), 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0.0)
    ...
    EffectCmd(0x14, 0xFFFE, 0x0C, 1.0, 0.0, 0.5, 0.0, 0x07D0, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x0D, 1.0, 0.0, 0.5, 0.0, 0x07D0, 0x03)
    Sleep(566)
    ...
    EffectCmd(0x14, 0xFFFE, 0x02, 1.0, 1.0, 1.0, 0.5, 0x0000, 0x03)
...
def AniBtlSCraft00():
    ...
    AnimeClipCmd(0x04, 0xFFFE, 'C_CHR081_SC1', '')
    ...
    EffectCmd(0x14, 0xFFFE, 0x06, 1.0, 1.0, 1.0, 0.2, 0x0000, 0x03)
    ...
    EffectCmd(0x14, 0xFFFE, 0x04, 1.0, 1.0, 1.0, 0.2, 0x0898, 0x03)
    EffectCmd(0x14, 0xFFFE, 0x05, 1.0, 1.0, 1.0, 0.2, 0x0898, 0x03)
    ...
    CameraCmd(0x0A, 0.3, 0.3, 0.3, 0x0064, 0x00FA, 0x0064, 0x0000, 0x0014, 0x00)
    ...
    PlayEffect(0xFFFE, (0xFF, 0x34, 0x0), 0xFFFF, 0x00000000, (0xDD, 'scrn'), (0xEE, 960.0, 0x0), (0xEE, 0.0, 0x0), (0xEE, 0.0, 0x0), 0.0, 0.0, 0.0, (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), 0x06)
    EffectCmd(0x14, 0xFFFE, 0x06, 1.0, 1.0, 1.0, 0.5, 0x0000, 0x03)
    ...
    CameraCmd(0x0A, 0.8, 0.8, 0.3, 0x0064, 0x0384, 0x012C, 0x0000, 0x000A, 0x00)
    ...
    EffectCmd(0x14, 0xFFFE, 0x05, 1.0, 1.0, 1.0, 0.0, 0x0DAC, 0x03)
    Sleep(500)
    ...
    CameraCmd(0x0A, 0.3, 0.4, 0.3, 0x0064, 0x0DAC, 0x012C, 0x0000, 0x000A, 0x00)
    ...
    EffectCmd(0x14, 0xFFFE, 0x03, 1.0, 1.0, 1.0, 0.0, 0x012C, 0x03)
    ChrSetRGBA(0xFFFE, 0.6, 0.6, 0.6, 0.0, 1500, 0x03)
    Sleep(333)

    CameraCmd(0x0A, 0.8, 0.8, 0.3, 0x0064, 0x09C4, 0x012C, 0x0000, 0x000A, 0x00)
...
def AniBtlSCraft00_Finish():
    ...
    Call(ScriptId.Current, 'BtlDefaultFace')
    PlayChrAnimeClip(0xFFFE, 'BTL_WAIT', 0x01, 0x00, 0x00, 0x00, 0x00, 0.5, -1.0, -1.0, -1.0, 0x00, 0x00)
    AnimeClipCmd(0x05, 0xFFFE, 'C_CHR081_SC1', '')
