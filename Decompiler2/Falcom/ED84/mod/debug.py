...
def SelectFlag_System():
    ...
    ToggleScenaFlags(ScenaFlag(0x0060, 0, 0x300))
    ...
    ToggleScenaFlags(ScenaFlag(0x0060, 3, 0x303))
    ...
    ToggleScenaFlags(ScenaFlag(0x0080, 0, 0x400))
    ...
    ToggleScenaFlags(ScenaFlag(0x0080, 1, 0x401))
    ...
    ToggleScenaFlags(ScenaFlag(0x0080, 2, 0x402))
    ...
    ToggleScenaFlags(ScenaFlag(0x0085, 2, 0x42A))
    ...
    ToggleScenaFlags(ScenaFlag(0x0073, 4, 0x39C))
    ...
    ToggleScenaFlags(ScenaFlag(0x0061, 6, 0x30E))
    ...
    ToggleScenaFlags(ScenaFlag(0x0062, 0, 0x310))
    ...
    ToggleScenaFlags(ScenaFlag(0x0062, 1, 0x311))
    ...
    ToggleScenaFlags(ScenaFlag(0x0080, 7, 0x407))
...
def SelectFlag_Ippan():
    ...
    ToggleScenaFlags(ScenaFlag(0x0B61, 1, 0x5B09))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B64, 0, 0x5B20))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B65, 3, 0x5B2B))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B67, 2, 0x5B3A))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B68, 5, 0x5B45))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6A, 6, 0x5B56))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6C, 2, 0x5B62))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6E, 7, 0x5B77))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6F, 5, 0x5B7D))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B73, 0, 0x5B98))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B74, 0, 0x5BA0))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B62, 4, 0x5B14))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B66, 4, 0x5B34))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B68, 0, 0x5B40))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B69, 3, 0x5B4B))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6B, 4, 0x5B5C))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6C, 7, 0x5B67))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B6E, 0, 0x5B70))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B70, 6, 0x5B86))
    ...
    ToggleScenaFlags(ScenaFlag(0x0B72, 1, 0x5B91))
...
def EV_Party_Set():
    ...
    Call(ScriptId.System, 'FC_TSMenu_Reset')
    OP_C4(0x02, 0x00, ChrTable['尤娜'])
    OP_C4(0x02, 0x00, ChrTable['亞爾緹娜'])
    OP_C4(0x02, 0x00, ChrTable['庫爾特'])
    OP_C4(0x02, 0x00, ChrTable['繆潔'])
    OP_C4(0x02, 0x00, ChrTable['亞修'])
    OP_C4(0x02, 0x01, ChrTable['艾略特'])
    OP_C4(0x02, 0x01, ChrTable['菲'])
    OP_C4(0x02, 0x01, ChrTable['莎拉'])
    ...
    OP_C4(0x02, 0x00, ChrTable['艾瑪'])
    OP_C4(0x02, 0x00, ChrTable['菲'])
    OP_C4(0x02, 0x00, ChrTable['勞拉'])
    OP_C4(0x02, 0x01, ChrTable['庫爾特'])
    OP_C4(0x02, 0x01, ChrTable['亞修'])
    OP_C4(0x02, 0x01, ChrTable['蓋烏斯'])
    OP_C4(0x02, 0x01, ChrTable['尤西斯'])
    OP_C4(0x02, 0x01, ChrTable['馬奇亞斯'])
    OP_C4(0x02, 0x01, ChrTable['艾略特'])
    OP_C4(0x02, 0x01, ChrTable['莎拉'])
    OP_C4(0x02, 0x02, ChrTable['黎恩'])
    OP_C4(0x02, 0x02, ChrTable['瑟蕾奴'])
    ...
    OP_C4(0x02, 0x00, ChrTable['約修亞'])
    OP_C4(0x02, 0x00, ChrTable['克洛'])
    OP_C4(0x02, 0x00, ChrTable['庫爾特'])
    OP_C4(0x02, 0x00, ChrTable['亞修'])
    OP_C4(0x02, 0x05, ChrTable['艾略特'])
    OP_C4(0x02, 0x05, ChrTable['馬奇亞斯'])
    OP_C4(0x02, 0x05, ChrTable['尤西斯'])
    OP_C4(0x02, 0x05, ChrTable['阿加特'])
    OP_C4(0x02, 0x05, ChrTable['蘭迪'])
    ...
    OP_C4(0x02, 0x01, ChrTable['艾絲蒂爾'])
    OP_C4(0x02, 0x01, ChrTable['玲'])
    OP_C4(0x02, 0x01, ChrTable['艾莉'])
    OP_C4(0x02, 0x01, ChrTable['緹歐'])
    OP_C4(0x02, 0x01, ChrTable['杜巴莉'])
    OP_C4(0x02, 0x01, ChrTable['尤娜'])
    OP_C4(0x02, 0x01, ChrTable['亞爾緹娜'])
    OP_C4(0x02, 0x05, ChrTable['亞莉莎'])
    OP_C4(0x02, 0x05, ChrTable['艾瑪'])
    OP_C4(0x02, 0x05, ChrTable['菲'])
    OP_C4(0x02, 0x05, ChrTable['勞拉'])
    OP_C4(0x02, 0x05, ChrTable['莎拉'])
    OP_C4(0x02, 0x05, ChrTable['提妲'])
    OP_C4(0x02, 0x05, ChrTable['安潔莉卡'])
    ...
    OP_C4(0x02, 0x02, ChrTable['艾絲蒂爾'])
    OP_C4(0x02, 0x02, ChrTable['尤娜'])
    OP_C4(0x02, 0x02, ChrTable['艾莉'])
    OP_C4(0x02, 0x02, ChrTable['緹歐'])
    OP_C4(0x02, 0x03, ChrTable['杜巴莉'])
    OP_C4(0x02, 0x03, ChrTable['亞爾緹娜'])
    OP_C4(0x02, 0x03, ChrTable['玲'])
    ...
    OP_C4(0x02, 0x02, ChrTable['克洛'])
    OP_C4(0x02, 0x02, ChrTable['杜巴莉'])
    OP_C4(0x02, 0x02, ChrTable['安潔莉卡'])
    OP_C4(0x02, 0x02, ChrTable['提妲'])
    OP_C4(0x02, 0x03, ChrTable['蘭迪'])
    OP_C4(0x02, 0x03, ChrTable['阿加特'])
    OP_C4(0x02, 0x03, ChrTable['緹歐'])
    MenuChrFlagCmd(0x00, ChrTable['黎恩'], 0x00000010)
    MenuChrFlagCmd(0x00, ChrTable['尤娜'], 0x00000010)
    MenuChrFlagCmd(0x00, ChrTable['庫爾特'], 0x00000010)
    SetScenaFlags(ScenaFlag(0x0072, 1, 0x391))
    ...
    Call(ScriptId.System, 'FC_TSMenu_Reset')
    OP_C4(0x02, 0x00, ChrTable['黎恩'])
    OP_C4(0x02, 0x00, ChrTable['瑟蕾奴'])
    OP_C4(0x02, 0x00, ChrTable['艾瑪'])
    OP_C4(0x02, 0x00, ChrTable['尤西斯'])
    OP_C4(0x02, 0x01, ChrTable['尤娜'])
    OP_C4(0x02, 0x01, ChrTable['庫爾特'])
    OP_C4(0x02, 0x01, ChrTable['亞爾緹娜'])
    OP_C4(0x02, 0x01, ChrTable['繆潔'])
    ...
    OP_C4(0x02, 0x01, ChrTable['菲'])
    OP_C4(0x02, 0x01, ChrTable['蓋烏斯'])
    OP_C4(0x02, 0x01, ChrTable['克洛'])
    OP_C4(0x02, 0x02, ChrTable['黎恩'])
    OP_C4(0x02, 0x02, ChrTable['尤娜'])
    OP_C4(0x02, 0x02, ChrTable['庫爾特'])
    OP_C4(0x02, 0x02, ChrTable['亞爾緹娜'])
    OP_C4(0x02, 0x02, ChrTable['繆潔'])
    OP_C4(0x02, 0x02, ChrTable['亞修'])
    MenuChrFlagCmd(0x00, ChrTable['黎恩'], 0x00000010)
    ...
    Call(ScriptId.System, 'FC_TSMenu_Reset')
    OP_C4(0x02, 0x00, ChrTable['艾絲蒂爾'])
    OP_C4(0x02, 0x00, ChrTable['約修亞'])
    OP_C4(0x02, 0x00, ChrTable['阿加特'])
    OP_C4(0x02, 0x00, ChrTable['提妲'])
    OP_C4(0x02, 0x00, ChrTable['玲'])
    OP_C4(0x02, 0x01, ChrTable['羅伊德'])
    OP_C4(0x02, 0x01, ChrTable['艾莉'])
    OP_C4(0x02, 0x01, ChrTable['緹歐'])
    OP_C4(0x02, 0x01, ChrTable['蘭迪'])
    OP_C4(0x02, 0x02, ChrTable['安潔莉卡'])
    OP_C4(0x02, 0x02, ChrTable['喬治'])
    OP_C4(0x02, 0x02, ChrTable['雪倫'])
    OP_C4(0x02, 0x02, ChrTable['緋之羅賽莉亞'])
    OP_C4(0x02, 0x03, ChrTable['杜巴莉'])
    OP_C4(0x02, 0x03, ChrTable['剛毅艾奈絲'])
    OP_C4(0x02, 0x03, ChrTable['魔弓恩奈雅'])
    OP_C4(0x02, 0x03, ChrTable['陷阱師傑諾'])
    OP_C4(0x02, 0x03, ChrTable['破壞獸雷歐尼達斯'])
    OP_C4(0x02, 0x04, ChrTable['奧蕾莉亞將軍'])
    OP_C4(0x02, 0x04, ChrTable['克洛提德'])
    OP_C4(0x02, 0x04, ChrTable['亞爾賽德子爵'])
    OP_C4(0x02, 0x04, ChrTable['遊擊士托瓦爾'])
    Call(ScriptId.System, 'FC_ResetMenuChrFlagALL')
    FormationReset(0x00)
    OP_C4(0x01, 0x00)
