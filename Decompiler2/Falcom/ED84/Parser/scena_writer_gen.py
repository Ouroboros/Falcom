...
def OP_34(arg1: int, arg2: float, arg3: float, arg4: float, arg5: float, arg6: int):
    # 0x34
    assert isinstance(arg1, int)
    assert isinstance(arg2, float)
...
def OP_41(arg1: int, arg2: int, *args):
    ...
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    return scena.handleOpCode(0x41, arg1, arg2, *args)
...
def OP_48(arg1: int, *args):
    # 0x48
    assert isinstance(arg1, int)
    return scena.handleOpCode(0x48, arg1, *args)
...
def OP_5A(arg1: int, *args):
    # 0x5A
    assert isinstance(arg1, int)
    return scena.handleOpCode(0x5A, arg1, *args)
...
def OP_61(arg1: int, *args):
    # 0x61
    assert isinstance(arg1, int)
    return scena.handleOpCode(0x61, arg1, *args)
...
def OP_78(arg1: int, arg2: str, *args):
    ...
    assert isinstance(arg1, int)
    assert isinstance(arg2, str)
    return scena.handleOpCode(0x78, arg1, arg2, *args)
...
def OP_9A(arg1: int, arg2: float, arg3: float, arg4: float, arg5: int):
    # 0x9A
    assert isinstance(arg1, int)
    assert isinstance(arg2, float)
    assert isinstance(arg3, float)
...
def OP_B5(arg1: int, arg2: int, arg3: float, arg4: float, arg5: float, arg6: int, arg7: int):
    # 0xB5
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float)
...
def OP_BD(arg1: int, *args):
    # 0xBD
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xBD, arg1, *args)
...
def OP_CE(arg1: int, *args):
    # 0xCE
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xCE, arg1, *args)
...
def OP_D0(arg1: int, *args):
    # 0xD0
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD0, arg1, *args)

def OP_D1(arg1: int, *args):
    # 0xD1
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD1, arg1, *args)

def OP_D2(arg1: int, *args):
    # 0xD2
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD2, arg1, *args)

def OP_D3(arg1: int, *args):
    # 0xD3
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD3, arg1, *args)

def OP_D4(arg1: int, *args):
    # 0xD4
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD4, arg1, *args)

def OP_D5(arg1: int, *args):
    # 0xD5
    assert isinstance(arg1, int)
    return scena.handleOpCode(0xD5, arg1, *args)
