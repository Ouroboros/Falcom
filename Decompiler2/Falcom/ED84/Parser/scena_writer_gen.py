...
def OP_19(arg1: int, arg2: int):
    # 0x19
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    scena.handleOpCode(0x19, arg1, arg2)
...
def CreateChr(chrId: int, model: str, name: str, monsterId: str, type: int, arg6: int, arg7: int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: float | int, arg13: float | int, arg14: float | int, arg15: str, arg16: str, arg17: int, arg18: int, arg19: float | int, arg20: float | int, arg21: int):
    # 0x1D
    ...
    assert isinstance(arg12, float | int)
    assert isinstance(arg13, float | int)
    assert isinstance(arg14, float | int)
    assert isinstance(arg15, str)
    assert isinstance(arg16, str)
    assert isinstance(arg17, int)
    assert isinstance(arg18, int)
    assert isinstance(arg19, float | int)
    assert isinstance(arg20, float | int)
...
def OP_1D(chrId: int, model: str, name: str, monsterId: str, type: int, arg6: int, arg7: int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: float | int, arg13: float | int, arg14: float | int, arg15: str, arg16: str, arg17: int, arg18: int, arg19: float | int, arg20: float | int, arg21: int):
    # 0x1D
    assert isinstance(chrId, int)
    assert isinstance(model, str)
    assert isinstance(name, str)
...
def OP_20(arg1: int, arg2: tuple | list, arg3: tuple | list, arg4: tuple | list, arg5: tuple | list):
    # 0x20
    assert isinstance(arg1, int)
    assert isinstance(arg2, tuple | list)
    ...
    scena.handleOpCode(0x20, arg1, arg2, arg3, arg4, arg5)
...
def WaitAnimeClip(chrId: int, expiration: float | int, animeSlot: int):
    # 0x2D
    assert isinstance(chrId, int)
    assert isinstance(expiration, float | int)
    assert isinstance(animeSlot, int)
    scena.handleOpCode(0x2D, chrId, expiration, animeSlot)

def OP_2D(chrId: int, expiration: float | int, animeSlot: int):
    # 0x2D
    assert isinstance(chrId, int)
    assert isinstance(expiration, float | int)
    assert isinstance(animeSlot, int)
...
def EquipCtrl(arg1: int, arg2: int, arg3: str, arg4: str, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: float | int, arg13: float | int):
    # 0x30
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, str)
    ...
    assert isinstance(arg6, float | int)
    assert isinstance(arg7, float | int)
    assert isinstance(arg8, float | int)
    assert isinstance(arg9, float | int)
    assert isinstance(arg10, float | int)
    assert isinstance(arg11, float | int)
...
def OP_30(arg1: int, arg2: int, arg3: str, arg4: str, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: float | int, arg13: float | int):
    # 0x30
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, str)
...
def OP_34(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int):
    # 0x34
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
    assert isinstance(arg4, float | int)
    assert isinstance(arg5, float | int)
    assert isinstance(arg6, int)
    scena.handleOpCode(0x34, arg1, arg2, arg3, arg4, arg5, arg6)
...
def SetChrPos(chrId: int, x: float | int, y: float | int, z: float | int, direction: float | int):
    # 0x37
    assert isinstance(chrId, int)
    ...
    scena.handleOpCode(0x37, chrId, x, y, z, direction)

def OP_37(chrId: int, x: float | int, y: float | int, z: float | int, direction: float | int):
    # 0x37
    assert isinstance(chrId, int)
    assert isinstance(x, float | int)
    assert isinstance(y, float | int)
...
def SetChrAni(arg1: int, arg2: int, arg3: str, arg4: float | int, arg5: float | int, arg6: int):
    # 0x39
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, str)
...
def OP_39(arg1: int, arg2: int, arg3: str, arg4: float | int, arg5: float | int, arg6: int):
    # 0x39
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, str)
...
def OP_3D(arg1: int, arg2: float | int, arg3: float | int, arg4: int):
    # 0x3D
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_3E(arg1: int, arg2: int, arg3: float | int, arg4: int):
    # 0x3E
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
...
def OP_42(arg1: int, arg2: int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: float | int, arg7: float | int, arg8: int, arg9: int):
    # 0x42
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
...
def OP_44(arg1: int, arg2: int, arg3: float | int, arg4: int, arg5: float | int):
    # 0x44
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
...
def OP_45(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: int, arg6: int):
    # 0x45
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_4A(arg1: float | int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: int, arg6: int):
    # 0x4A
...
def OP_4B(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int, arg7: int):
    # 0x4B
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_4C(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: int, arg6: int):
    # 0x4C
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_4E(arg1: float | int, arg2: float | int, arg3: int):
    # 0x4E
    assert isinstance(arg1, float | int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, int)
...
def OP_50(arg1: tuple | list, arg2: str, arg3: int):
    # 0x50
    assert isinstance(arg1, tuple | list)
    assert isinstance(arg2, str)
    assert isinstance(arg3, int)
    scena.handleOpCode(0x50, arg1, arg2, arg3)

def OP_51(arg1: float | int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int, arg7: float | int, arg8: float | int, arg9: float | int, arg10: float | int):
    # 0x51
    assert isinstance(arg1, float | int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_55(arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: int, arg7: int, arg8: int, arg9: int, arg10: int, arg11: int, arg12: float | int, arg13: float | int, arg14: float | int, arg15: float | int, arg16: int, arg17: int, arg18: str, arg19: str):
    # 0x55
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
    ...
    assert isinstance(arg13, float | int)
    assert isinstance(arg14, float | int)
    assert isinstance(arg15, float | int)
...
def OP_56(arg1: int, arg2: int, arg3: int, arg4: float | int, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int):
    # 0x56
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
...
def OP_5D(arg1: int, arg2: str, arg3: float | int, arg4: float | int, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: int, arg13: int, arg14: int):
    # 0x5D
    assert isinstance(arg1, int)
    assert isinstance(arg2, str)
    assert isinstance(arg3, float | int)
...
def OP_62(arg1: int, arg2: int):
    # 0x62
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    scena.handleOpCode(0x62, arg1, arg2)
...
def OP_64(arg1: int, arg2: float | int):
    # 0x64
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
...
def OP_6B(arg1: int, arg2: int, arg3: int, arg4: float | int, arg5: int, arg6: int):
    # 0x6B
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
...
def OP_6C(arg1: int, arg2: float | int):
    # 0x6C
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    scena.handleOpCode(0x6C, arg1, arg2)

def OP_6E(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int):
    # 0x6E
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def AddItem(arg1: int, arg2: int, arg3: int):
    # 0x6F
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
...
def OP_71(arg1: int, arg2: int, arg3: int):
    # 0x71
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
    scena.handleOpCode(0x71, arg1, arg2, arg3)
...
def OP_76(arg1: int, arg2: str, arg3: str, arg4: int, arg5: int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: float | int):
    # 0x76
    assert isinstance(arg1, int)
    assert isinstance(arg2, str)
    assert isinstance(arg3, str)
...
def OP_80(arg1: float | int):
    # 0x80
    assert isinstance(arg1, float | int)
    scena.handleOpCode(0x80, arg1)

def OP_82(arg1: int, arg2: float | int, arg3: float | int, arg4: int, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: int):
    # 0x82
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_86(arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: int, arg7: int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: str):
    # 0x86
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
...
def OP_8B(arg1: float | int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int):
    # 0x8B
    assert isinstance(arg1, float | int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_8D(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int):
    # 0x8D
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_8E(arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: int, arg7: int, arg8: int):
    # 0x8E
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, int)
    ...
    assert isinstance(arg7, int)
    assert isinstance(arg8, int)
    scena.handleOpCode(0x8E, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
...
def OP_9A(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: int):
    # 0x9A
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
    assert isinstance(arg4, float | int)
    assert isinstance(arg5, int)
    scena.handleOpCode(0x9A, arg1, arg2, arg3, arg4, arg5)
...
def OP_A1(arg1: float | int, arg2: float | int, arg3: float | int, arg4: int, arg5: int):
    # 0xA1
    assert isinstance(arg1, float | int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_A6(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int):
    # 0xA6
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def SetEndhookFunction(arg1: str, arg2: int):
    # 0xAE
    assert isinstance(arg1, str)
    assert isinstance(arg2, int)
...
def OP_B3(arg1: float | int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: int, arg6: int):
    # 0xB3
    assert isinstance(arg1, float | int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_B5(arg1: int, arg2: int, arg3: float | int, arg4: float | int, arg5: float | int, arg6: int, arg7: int):
    # 0xB5
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
    ...
    assert isinstance(arg6, int)
    assert isinstance(arg7, int)
    scena.handleOpCode(0xB5, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
...
def OP_BE(arg1: int, arg2: int, arg3: float | int, arg4: float | int):
    # 0xBE
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
...
def OP_D6(arg1: int, arg2: tuple | list, arg3: tuple | list, arg4: tuple | list, arg5: tuple | list):
    # 0xD6
    assert isinstance(arg1, int)
    assert isinstance(arg2, tuple | list)
    assert isinstance(arg3, tuple | list)
    assert isinstance(arg4, tuple | list)
    assert isinstance(arg5, tuple | list)
    scena.handleOpCode(0xD6, arg1, arg2, arg3, arg4, arg5)

def AddBattleCount(arg1: int, arg2: int):
    # 0xD7
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    scena.handleOpCode(0xD7, arg1, arg2)

def OP_D7(arg1: int, arg2: int):
    # 0xD7
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    scena.handleOpCode(0xD7, arg1, arg2)
