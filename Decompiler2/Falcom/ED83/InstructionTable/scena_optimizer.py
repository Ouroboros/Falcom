...
optimizeTable = buildTable(
    ...
    opt(
        ...
        ('BattleCreateChrAfterImage',           {0: 0x30}),
        ('BattleSetChrPos',                     {0: 0x33}),
        ('BattleMoveToTarget',                  {0: 0x34}),
        ...
        ('BattleSetChrAbnormalStatus2',         {0: 0xB7, 1: 0x02}),
        ('BattleClearChrAbnormalStatus2',       {0: 0xB7, 1: 0x03, 4: 0, 5: 0, 6: 0}),
        ('BattleGetChrAbnormalStatus',          {0: 0xB7, 1: 0x04, 3: 0, 4: 0, 5: 0, 6: 0}),
        ('BattleGetChrAbnormalStatus2',         {0: 0xB7, 1: 0x05, 3: 0, 4: 0, 5: 0, 6: 0}),
    ),
    opt(
        0x35,
