...
def CreateChr(chrId: int, model: str, name: str, monsterId: str, type: uint8, arg6: uint32, arg7: uint32, arg8: float32, arg9: float32, arg10: float32, arg11: float32, arg12: float32, arg13: float32, arg14: float32, arg15: str, arg16: str, arg17: uint32, arg18: uint8, arg19: float32, arg20: float32, arg21: uint16):
    # 0x1D
...
def OP_1D(chrId: int, model: str, name: str, monsterId: str, type: uint8, arg6: uint32, arg7: uint32, arg8: float32, arg9: float32, arg10: float32, arg11: float32, arg12: float32, arg13: float32, arg14: float32, arg15: str, arg16: str, arg17: uint32, arg18: uint8, arg19: float32, arg20: float32, arg21: uint16):
    # 0x1D
    assert isinstance(chrId, int)
    assert isinstance(model, str)
    assert isinstance(name, str)
...
def OP_1E(arg1: int, arg2: uint8, arg3: uint8, arg4: str):
    # 0x1E
    assert isinstance(arg1, int)
    assert isinstance(arg2, uint8)
    assert isinstance(arg3, uint8)
    assert isinstance(arg4, str)
    _gScena.handleOpCode(0x1E, arg1, arg2, arg3, arg4)
...
def ChrTalk(chrId: int, flags: uint32, text: str | tuple):
    # 0x24
    assert isinstance(chrId, int)
...
def OP_24(chrId: int, flags: uint32, text: str | tuple):
    # 0x24
    assert isinstance(chrId, int)
    assert isinstance(flags, uint32)
    assert isinstance(text, str | tuple)
...
def PlayChrAnimeClip(arg1: uint16, arg2: str, arg3: uint8, arg4: uint8, arg5: uint8, arg6: uint8, arg7: uint8, arg8: float32, arg9: float32, arg10: float32, arg11: float32, arg12: uint8, arg13: uint8):
    # 0x2C
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, str)
    assert isinstance(arg3, uint8)
    ...
    _gScena.handleOpCode(0x2C, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13)

def OP_2C(arg1: uint16, arg2: str, arg3: uint8, arg4: uint8, arg5: uint8, arg6: uint8, arg7: uint8, arg8: float32, arg9: float32, arg10: float32, arg11: float32, arg12: uint8, arg13: uint8):
    # 0x2C
    assert isinstance(arg1, uint16)
    assert isinstance(arg2, str)
    assert isinstance(arg3, uint8)
...
def OP_35(arg1: uint8, arg2: int, arg3: uint32):
    # 0x35
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, int)
...
def SetChrPos(chrId: int, x: float32, y: float32, z: float32, direction: float32):
    # 0x37
    assert isinstance(chrId, int)
...
def OP_37(chrId: int, x: float32, y: float32, z: float32, direction: float32):
    # 0x37
    assert isinstance(chrId, int)
    assert isinstance(x, float32)
    assert isinstance(y, float32)
...
def OP_38(arg1: int, arg2: uint8, arg3: uint8, arg4: str):
    # 0x38
    assert isinstance(arg1, int)
    assert isinstance(arg2, uint8)
    assert isinstance(arg3, uint8)
...
def SetChrAni(arg1: int, arg2: uint8, arg3: str, arg4: float32, arg5: float32, arg6: uint32):
    # 0x39
    assert isinstance(arg1, int)
    assert isinstance(arg2, uint8)
    assert isinstance(arg3, str)
...
def OP_39(arg1: int, arg2: uint8, arg3: str, arg4: float32, arg5: float32, arg6: uint32):
    # 0x39
    assert isinstance(arg1, int)
    assert isinstance(arg2, uint8)
    assert isinstance(arg3, str)
...
def OP_45(arg1: int, arg2: float32, arg3: float32, arg4: float32, arg5: uint16, arg6: uint16):
    # 0x45
    assert isinstance(arg1, int)
    assert isinstance(arg2, float32)
    assert isinstance(arg3, float32)
...
def MenuChrFlagCmd(arg1: uint8, arg2: int, arg3: uint32):
    # 0xB1
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, int)
    assert isinstance(arg3, uint32)
...
def OP_B1(arg1: uint8, arg2: int, arg3: uint32):
    # 0xB1
    assert isinstance(arg1, uint8)
    assert isinstance(arg2, int)
    assert isinstance(arg3, uint32)
