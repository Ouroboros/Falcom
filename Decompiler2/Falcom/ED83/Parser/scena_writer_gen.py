...
def OP_2D(arg1: int, arg2: float | int, arg3: int):
    # 0x2D
    assert isinstance(arg1, int)
...
def OP_34(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int, arg5: float | int):
    # 0x34
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
...
def OP_61(arg1: int, arg2: str, arg3: int, arg4: int, arg5: float | int, arg6: float | int, arg7: float | int, arg8: float | int, arg9: float | int, arg10: float | int, arg11: float | int, arg12: int):
    # 0x61
    assert isinstance(arg1, int)
    assert isinstance(arg2, str)
    assert isinstance(arg3, int)
...
def OP_9A(arg1: int, arg2: float | int, arg3: float | int, arg4: float | int):
    # 0x9A
    assert isinstance(arg1, int)
    assert isinstance(arg2, float | int)
    assert isinstance(arg3, float | int)
...
def OP_B5(arg1: int, arg2: int, arg3: float | int, arg4: float | int, arg5: float | int):
    # 0xB5
    assert isinstance(arg1, int)
    assert isinstance(arg2, int)
    assert isinstance(arg3, float | int)
