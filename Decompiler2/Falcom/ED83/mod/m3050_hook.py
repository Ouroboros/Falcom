...
def EV_Template(before_second_battle):
    ...
    CameraSetPos(0x03, -45.11, 114.78, -0.6, 0)
    ...
    if before_second_battle:
        ...
        CameraSetPos(0x03, -34.66, 115.17 - 0.5, -14.32, 0)
        CameraRotate(0x03, 358.0, 351.0, 355.0, 0, 0x01)
        CameraSetDistance(0x03, 3.2, 0)
        CameraCmd(0x0B, 0x03, 34.6, 0x0000)
        CameraSetPos(0x03, -34.67, 115.25 - 0.5, -14.43, 20000)
        CameraRotate(0x03, 356.0, 2.0, 355.0, 20000, 0x01)
        CameraSetDistance(0x03, 2.6, 20000)
    ...
    CameraSetPos(0x03,  -45.11, 114.79, -0.8, 0)
    ...
    CameraSetPos(0x03, -45.08, 115.14, -0.9, 3000)
    ...
    if before_second_battle:
        ...
        CameraSetPos(0x03, -45.08, 115.14, -0.58, 0)
    ...
    if before_second_battle:
        ...
        CameraSetPos(0x03, -40, 114.5, -0.5, 0)
        ...
        CameraSetPos(0x03, -39.2, 114.5, -0.7, 20000)

        # CameraRotate(0x03, 0.0, 294.0, 0.0, 20000, 0x01)
        CameraRotate(0x03, 0.0, 281.0, 0.0, 20000, 0x01)
        ...
        CameraSetPos(0x03, -39.5, 114.5 + 1.0, -0.5, 0)
        CameraRotate(0x03, 31.0, 281.0, 0.0, 0, 0x01)
        CameraSetDistance(0x03, 1.3, 0)
        CameraCmd(0x0B, 0x03, 34.6, 0x0000)
        CameraSetPos(0x03, -38.7, 114.5 + 1.0, -0.7, 10000)
        CameraRotate(0x03, 60.0, 281.0, 0.0, 10000, 0x01)
        CameraSetDistance(0x03, 1.8, 10000)
