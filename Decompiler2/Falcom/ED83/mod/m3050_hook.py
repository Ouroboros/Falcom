...
def EV_Template(before_second_battle):
    ...
    ChrLoadMultipleAnimeClips(ChrTable['奧蕾莉亞分校長'], 0x00, 'AniEvDead1', 'AniEvWeak', 'AniEvBtlWait', 'AniEvFieldAttackEnd', 'AniEv34085', 'AniEvDead2', '', '', '', '', '', '', '', '', '', '')

    if before_second_battle:
        ChrLoadMultipleAnimeClips(ChrTable['悠娜'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['庫爾特'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['亞爾緹娜'], 0x00, 'AniEvTeMune', 'AniEvPhoneLook', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')

    else:
        ChrLoadMultipleAnimeClips(ChrTable['悠娜'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['庫爾特'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['亞爾緹娜'], 0x00, 'AniEvTeMune', 'AniEvPhoneLook', 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['安潔莉卡'], 0x00, 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['亞修'], 0x00, 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
        ChrLoadMultipleAnimeClips(ChrTable['妙婕'], 0x00, 'AniEvDead1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
