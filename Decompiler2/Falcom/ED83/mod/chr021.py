...
def AniBtlLoad():
    If(
        (
            (Expr.Eval, "BattleCmd(0x62, 0xFFFE, 0x12)"),
            Expr.Return,
        ),
        'loc_8E93',
    )

    AnimeClipCmd(0x00, 0xFFFE, 'C_CHR021_DF1', 'WAIT')
...
def AniFieldAttack():
    ...
    CameraCmd(0x0A, 0.0, 0.1, 1.0, 0x001E, 0x0064, 0x001E, 0x0000, 0x0000, 0x00)
    Sleep(66)
    OP_41(0xFFFE, 0x01)
    Sleep(200)
    OP_AD(0x01, 0x01)
...
def AniFieldAttack2():
    ...
    CameraCmd(0x0A, 0.0, 0.1, 1.0, 0x001E, 0x010E, 0x001E, 0x0000, 0x0000, 0x00)
    Sleep(66)
    OP_41(0xFFFE, 0x01)
    Sleep(266)
    OP_AD(0x00, 0x01)
...
def AniAssaultAttack():
    ...
    CameraCmd(0x0A, 0.0, 0.2, 0.0, 0x003C, 0x0001, 0x0190, 0x0000, 0x0000, 0x00)
...
def AniBtlReady():
    If(
        (
            (Expr.Eval, "BattleCmd(0x62, 0xFFFE, 0x07)"),
            Expr.Return,
        ),
        'loc_B02D',
    )
...
def AniBtlWin():
    ...
    CameraCmd(0x0B, 0x03, 40.0, 0x0000)
    CameraCmd(0x14, 0x02, 0xFFFE, '', 0.2, 1.35, 0.3, 4000)
    CameraRotateByTarget(0xFFFE, '', 0x02, 8.0, -8.0, 0.0, 4000, 0x01)
    CameraCmd(0x05, 0x02, 1.9, 4000)
    SetChrFace(0x03, 0xFFFE, '0[autoE0]', '0[autoM0]', '', '#b', '0')
    OP_45(0xFFFE, 0.0, 0.0, 0.0, 0x0000, 0x0001)
    OP_45(0xFFFE, 0.0, 0.0, 0.0, 0x0000, 0x0000)
    OP_46(0x00, 0xFFFE, 0xFFFF, 0x0000)
...
def AniBtlAttack():
    ...
    CameraCmd(0x0A, 0.1, 0.2, 0.1, 0x001E, 0x0190, 0x003C, 0x0000, 0x0000, 0x00)
...
def AniBtlTensionMax():
    ...
    CameraCmd(0x16, 0x03, 1.0, 450)
    CameraCmd(0x0C, 0x03, 0.0, 0.1, 0.0, 450)
    Sleep(333)
    CameraCmd(0x16, 0x03, 1.0, 5000)
...
def AniBtlLinkRush():
    ...
    If(
        (
            (Expr.Eval, "BattleCmd(0x0F, 0xFFFE, 0x0001)"),
            (Expr.PushLong, 0x0),
            Expr.Equ,
            Expr.Return,
        ),
    ...
    BattleCmd(0x4A, 1.3)
    BattleCmd(0x48, 0xFFFE)
    BattleCmd(0x46, 0.0, -1.0, 15.0)
    BattleCmd(0x48, 0xFFFB)
    BattleCmd(0x46, 0.25, -1.0, 15.0)
...
def AniBtlCraft00():
    ...
    CameraCmd(0x0A, 0.016, 0.01, 0.01, 0x0064, 0x0640, 0x03E8, 0x0000, 0x0000, 0x00)
    OP_6C(0xFFFE, 0.15)
    Sleep(1333)
    Fade(0x65, 100, 1.0, 0x0000)
    Fade(0xFE, 0)
    ...
    CameraCmd(0x0A, 0.03, 0.03, 0.01, 0x001E, 0x0190, 0x03E8, 0x0000, 0x0000, 0x00)
    ...
    CameraCmd(0x0A, 0.15, 0.15, 0.01, 0x0064, 0x0258, 0x03E8, 0x0000, 0x0000, 0x00)
...
def AniBtlCraft01():
    ...
    OP_6C(0xFFFE, 1.0)
    CameraCmd(0x0A, 0.05, 0.05, 0.01, 0x001E, 0x00C8, 0x0064, 0x0000, 0x0000, 0x00)
    ...
    CameraCmd(0x16, 0x03, -0.65, 1000)
    CameraCmd(0x0A, 0.035, 0.02, 0.01, 0x0000, 0x05DC, 0x03E8, 0x0000, 0x0000, 0x00)
    ...
    EffectCmd(0x0F, 0xFFFE, 0x0093, 0x01)
    CameraCmd(0x00)
    ...
    CameraCmd(0x0A, 0.32, 0.22, 0.01, 0x001E, 0x05DC, 0x03E8, 0x0000, 0x0000, 0x00)
...
def AniBtlCraft02():
    ...
    CameraCmd(0x16, 0x03, 1.0, 450)
    CameraCmd(0x0C, 0x03, 0.0, 0.1, 0.0, 450)
    CameraCmd(0x0A, 0.07, 0.07, 0.01, 0x0064, 0x0384, 0x04B0, 0x0000, 0x0000, 0x00)
...
def AniBtlSCraft00():
    ...
    AnimeClipCmd(0x04, 0xFFFE, 'C_CHR021_SC1', '')
    BattleCmd(0x52, 0xFFFE, 0x90)
    ...
    AnimeClipCmd(0x04, 0x0B5F, 'C_CHR021_SC1', '')
    AnimeClipCmd(0x04, 0x0B60, 'C_CHR021_SC1', '')
    ...
    CameraCmd(0x0B, 0x03, 40.0, 0x0000)
    CameraCmd(0x02, 0x02, -0.26, 1.25, -50.07, 3000)
    ChrSetPhysicsFlags(0xFFF9, 0x00000040)
    ChrSetPhysicsFlags(0xFFF9, 0x00000020)
    ...
    OP_6C(0xFFFE, 0.5)
    Sleep(333)
    CameraCmd(0x02, 0x02, -0.56, 0.82, -50.1, 500)
    CameraCmd(0x04, 0x02, 353.0, 342.0, 1.0, 500, 0x01)
    CameraCmd(0x05, 0x02, 2.2, 500)
    CameraCmd(0x0B, 0x02, 57.2, 0x01F4)
    SetChrFace(0x03, 0xFFFE, '6', '2[autoM2]', '6', '#b', '0')
    OP_6C(0xFFFE, 1.0)
    CameraCmd(0x0A, 0.0, 0.4, 0.0, 0x0000, 0x0032, 0x012C, 0x0000, 0x0000, 0x00)
    ...
    ChrClearPhysicsFlags(0xFFF9, 0x00000040)
    ChrClearPhysicsFlags(0xFFF9, 0x00000020)
    EffectCmd(0x0F, 0xFFFE, 0x0096, 0x01)
    ...
    OP_6C(0xFFFE, 0.4)
    Sleep(833)
    CameraCmd(0x02, 0x02, 0.18, 1.05, -50.15, 700)
    CameraCmd(0x04, 0x02, 357.0, 85.0, 0.0, 700, 0x01)
    CameraCmd(0x05, 0x02, 1.1, 700)
    ...
    Sleep(400)
    CameraCmd(0x02, 0x01, -0.25, 0.49, 0.0, 800)
    Sleep(400)
    ...
    BattleCmd(0x3A, 0x0B5E)
    EffectCmd(0x0F, 0xFFFE, 0x0092, 0x01)
    CameraCmd(0x0A, 1.0, 1.4, 0.0, 0x0000, 0x00C8, 0x012C, 0x0000, 0x0000, 0x00)
    ...
    CameraCmd(0x02, 0x02, -0.61, -1.6, 9.13, 1000)
    CameraCmd(0x04, 0x02, 327.0, 195.0, 0.0, 1000, 0x01)
    CameraCmd(0x05, 0x02, 13.6, 1000)
    ...
    CameraCmd(0x00)
    CameraCmd(0x14, 0x02, 0xFFFE, '', 0.39, 1.72, 2.27, 500)
    CameraRotateByTarget(0xFFFE, '', 0x02, -26.0, 28.0, 0.0, 500, 0x01)
    CameraCmd(0x05, 0x02, 0.8, 500)
    ...
    CameraCmd(0x05, 0x00, 1.0, 1200)
    CameraCmd(0x0A, 0.0, 0.1, 0.0, 0x0064, 0x03E8, 0x0064, 0x0000, 0x0000, 0x00)
    ...
    CameraCmd(0x0A, 0.0, 0.0, 0.0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00)
    ...
    Sleep(333)
    OP_3B(0xFF, 0.7, 1.0, 0.6)
    CameraCmd(0x0A, 0.0, 0.4, 0.0, 0x0000, 0x0032, 0x0064, 0x0000, 0x0000, 0x00)
    ...
    CameraCmd(0x14, 0x02, 0xFFFE, '', 0.82, 0.74, 3.25, 4000)
    CameraRotateByTarget(0xFFFE, '', 0x02, -8.0, 164.0, 0.0, 4000, 0x01)
    CameraCmd(0x05, 0x02, 2.6, 4000)
    ...
    CameraCmd(0x0A, 0.0, 0.4, 0.0, 0x0000, 0x08FC, 0x03E8, 0x0000, 0x0000, 0x00)
    WaitAnimeClip(0xFFFE, 0.0, 0x00)
...
def AniBtlSCraft00_finish():
    ...
    WaitForThreadExit(0xFFFE, 0x02)
    Call(ScriptId.Current, 'BtlDefaultFace')
    AnimeClipCmd(0x05, 0xFFFE, 'C_CHR021_SC1', '')
...
def AniBtlSCraft00_sub1():
    ...
    CameraCmd(0x14, 0x00, 0xFFFE, '', 0.82, 1.44, 2.82, 1)
    Sleep(0)
