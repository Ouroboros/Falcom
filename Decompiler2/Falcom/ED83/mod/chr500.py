...
def AniTurn():
    If(
        (
            (Expr.Eval, "ChrSetVisibleFlags(0x02, 0xFFFE, 0x00000000)"),
            (Expr.PushLong, 0x10),
            Expr.And,
            Expr.Return,
        ),
...
def AniBtlCraft00():
    ...
    Fade(0x65, 100, 1.0, 0x0000)
    Fade(0xFE, 0)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000040)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000020)
    ...
    OP_3B(0xFF, 0.5, 0.7, 0.2)
    Sleep(100)
    ChrSetVisibleFlags(0x01, 0xFFF9, 0x00000040)
...
def AniBtlCraft01():
    ...
    Sleep(266)
    CameraCtrl(0x16, 0x03, 4.0, 5000)
    CameraRotateByTarget(0xFFFE, '', 0x03, -25.0, -3.0, 0.0, 5000, 0x01)
    CameraCtrl(0x0C, 0x03, 0.0, 2.24208e-44, 0.0, 5000)
    Sleep(333)
    ...
    CameraCtrl(0x0C, 0x03, 0.0, 0.5, 0.0, 4000)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000080)
...
def AniBtlCraft03():
    ...
    Fade(0x65, 100, 1.0, 0x0000)
    Fade(0xFE, 0)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000020)
    ChrSavePosition(0xFFFE, 0)
    ChrTurnDirection(0xFFFE, 0xFFF5, 0.0, -1.0)
    ChrCreateDummy(0xFFFE, 5)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000800)
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B5F, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B60, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B61, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000080)
    ChrSetVisibleFlags(0x00, 0x0B5F, 0x00000080)
    ChrSetVisibleFlags(0x00, 0x0B60, 0x00000080)
    ChrSetVisibleFlags(0x00, 0x0B61, 0x00000080)
    ...
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B5F, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B5F, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B60, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B60, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B61, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B61, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B62, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B62, 0x00000020)
    CameraCtrl(0x00)
    BattleChrCtrl(0x47)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000040)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000020)
    ...
    OP_6C(0x0B5E, 0.675)
    ChrSetVisibleFlags(0x01, 0x0B5E, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B5E, 0x00000020)
    ...
    OP_6C(0x0B5F, 0.6)
    ChrSetVisibleFlags(0x01, 0x0B5F, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B5F, 0x00000020)
    ...
    OP_6C(0x0B60, 0.525)
    ChrSetVisibleFlags(0x01, 0x0B60, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B60, 0x00000020)
    ...
    OP_6C(0x0B61, 0.45)
    ChrSetVisibleFlags(0x01, 0x0B61, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B61, 0x00000020)
    ...
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000040)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000040)
    ChrSetVisibleFlags(0x00, 0x0B5E, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B5F, 0x00000040)
    ...
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x00000040)
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x00000020)
    Sleep(166)
    ...
    Call(ScriptId.BtlCom, 'AniBtlCraftFinish')
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x00000020)
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x00000800)
...
def AniBtlCraft04():
    ...
    ChrSetVisibleFlags(0x00, 0xFFFB, 0x00000080)
    ...
    ChrSetVisibleFlags(0x01, 0xFFFB, 0x00000040)
    ChrSetVisibleFlags(0x01, 0xFFFB, 0x00000020)
    Fade(0xFF, 0, 0x0000)
    ChrSetVisibleFlags(0x01, 0x0B5E, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B5E, 0x00000020)
    ChrSetVisibleFlags(0x01, 0x0B5F, 0x00000040)
    ...
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x00000020)
    ChrSetVisibleFlags(0x01, 0xFFFB, 0x00000020)
    ChrSetVisibleFlags(0x01, 0xFFFB, 0x00000080)
...
def AniBtlSCraft00():
    ...
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000020)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000080)
    ChrSetVisibleFlags(0x00, 0xFFFE, 0x00000200)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000020)
    ChrSetVisibleFlags(0x00, 0xFFF9, 0x00000080)
    ...
    ChrSetVisibleFlags(0x01, 0x0B68, 0x00000040)
    ChrSetVisibleFlags(0x01, 0x0B68, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B68, 0x00000020)
    ChrSetVisibleFlags(0x00, 0x0B68, 0x00000200)
    ChrSetVisibleFlags(0x00, 0x0B68, 0x00000080)
    ...
    ChrSetVisibleFlags(0x01, 0xFFFE, 0x000002A0)
    ChrSetVisibleFlags(0x01, 0xFFF9, 0x000002A0)
