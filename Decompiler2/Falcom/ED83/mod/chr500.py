...
def AniBtlDead():
    ...
    If(
        (
            (Expr.Eval, "BattleCtrl(0xBA, (0x11, 0x4, 0x0), 'chr033')"),
            Expr.Ez,
            Expr.Return,
        ),
        'loc_8DDA',
    ...
    If(
        (
            (Expr.Eval, "BattleCtrl(0xBA, (0x11, 0x4, 0x0), 'chr035')"),
            Expr.Return,
        ),
        'loc_8D80',
    )

    BattleCtrl(0xBB, (0x11, 0x2, 0x0), (0xFF, 0x0, 0x0))
    ...
    If(
        (
            (Expr.Eval, "BattleCtrl(0xBA, (0x11, 0x4, 0x0), 'chr039')"),
            Expr.Return,
        ),
        'loc_8DAD',
    )

    BattleCtrl(0xBB, (0x11, 0x2, 0x0), (0xFF, 0x1, 0x0))
    ...
    If(
        (
            (Expr.Eval, "BattleCtrl(0xBA, (0x11, 0x4, 0x0), 'chr037')"),
            Expr.Return,
        ),
        'loc_8DDA',
    )

    BattleCtrl(0xBB, (0x11, 0x2, 0x0), (0xFF, 0x2, 0x0))
    ...
    If(
        (
            (Expr.Eval, "BattleCtrl(0x0F, 0xF080, 0x0000)"),
            (Expr.PushLong, 0x1),
            Expr.Equ,
            Expr.Return,
        ),
...
def AniBtlRelease():
    ...
    ChrClearAbnormalCondition(0xF080, 0x00008000)
    ChrClearAbnormalCondition(0xF080, 0x00400000)
    DebugLog(0x00, (0xFF, 0xA, 0x0))
    ...
    ChrClearAbnormalCondition(0xF081, 0x00008000)
    ChrClearAbnormalCondition(0xF081, 0x00400000)
    ...
    ChrClearAbnormalCondition(0xF082, 0x00008000)
    ChrClearAbnormalCondition(0xF082, 0x00400000)
