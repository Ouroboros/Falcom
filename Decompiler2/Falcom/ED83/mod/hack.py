...
def hack_debug_map():
    if 1:
        ...
        ChrAnimeClipCtrl(0x0A, chrid, '', '')
        # ChrAnimeClipCtrl(0x0A, chrid, 'C_CHR033', '')
...
def hack_EV_03_81_01():
    ...
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['尤西斯'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['米莉亞姆'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['蓋烏斯'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    OP_35(0x00, ChrTable['莎拉'], 0x00000010)
    OP_38(ChrTable['莎拉'], 0x00, 0x00, 'AniEvAttachEquip')
    OP_38(ChrTable['莎拉'], 0x00, 0x00, 'AniSetWorkWait')
    SetChrAni(ChrTable['莎拉'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['奧蕾莉亞分校長'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['尤西斯'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['米莉亞姆'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['蓋烏斯'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['莎拉'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['奧蕾莉亞分校長'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['悠娜'], 0x00, 'AniEvOdoroki', -1.000000, 1.000000, 0x00000001)
    SetChrAni(ChrTable['庫爾特'], 0x00, 'AniEvOdoroki', -1.000000, 1.000000, 0x00000001)
    SetChrAni(ChrTable['亞爾緹娜'], 0x00, 'AniEvTeMune', -1.000000, 1.000000, 0x00000001)
    ...
    SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['神速杜巴莉'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['剛毅艾奈絲'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['魔弓恩奈雅'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)

    SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniEvGourei', -1.000000, 1.000000, 0x00000000)

    SetChrAni(ChrTable['神速杜巴莉'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['剛毅艾奈絲'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['魔弓恩奈雅'], 0x00, 'AniEvDead1', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniAttachMainWeapon', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['魔弓恩奈雅'], 0x00, 'AniAttachMainWeapon', -1.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['永世α'], 0x00, 'AniEvk1023', -1.000000, 1.000000, 0x00000000)
    ...
    Fade(0xFF, 0, 0x0000)
    SetChrAni(ChrTable['亞修'], 0x00, 'AniEvWait1', 1.000000, 0.800000, 0x00000000)
    ...
    Fade(0xFF, 0, 0x0000)
    # SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniEv32030', -1.000000, 0.700000, 0x00000000)
    ...
    # SetChrAni(ChrTable['奧蕾莉亞分校長'], 0x00, 'AniEvBtlWait', 1.000000, 0.800000, 0x00000000)
    Fade(0xFF, 0, 0x0000)
    ...
    OP_26()
    # SetChrAni(ChrTable['奧蕾莉亞分校長'], 0x00, 'AniEvFieldAttackEnd', -1.000000, 0.800000, 0x00000000)
    OP_16(0x05DC)
    Fade(0x65, 500, 1.000000, 0x0000)
    Fade(0xFE, 0)
    CameraCtrl(0x00)
    ...
    SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniDetachMainWeapon', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['鋼之雅里安洛德'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['悠娜'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['庫爾特'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['亞修'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrFace(0x03, ChrTable['安潔莉卡'], '2[autoE2]', '2[autoM2]', '0[autoB0]', '#b', '0')
    ...
    OP_38(ChrTable['黎恩'], 0x00, 0x00, 'AniSetWorkWait')
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniEvSquat', -1.000000, 0.800000, 0x00000002)
    SetChrFace(0x03, ChrTable['黎恩'], '2[autoE2]', '2[autoM2]', '0[autoB0]', '#b', '0')
    SetChrFace(0x03, ChrTable['尤西斯'], '2[autoE2]', '2[autoM2]', '0[autoB0]', '#b', '0')
    SetChrFace(0x03, ChrTable['蓋烏斯'], '2[autoE2]', '2[autoM2]', '0[autoB0]', '#b', '0')
    SetChrFace(0x03, ChrTable['莎拉'], '2[autoE2]', '2[autoM2]', '0[autoB0]', '#b', '0')
    ...
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniEv00024', 1.000000, 1.000000, 0x00000000)
    ...
    OP_38(ChrTable['米莉亞姆'], 0x00, 0x00, 'AniSetWorkWait')
    SetChrAni(ChrTable['米莉亞姆'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['莎拉'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['尤西斯'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['米莉亞姆'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['神速杜巴莉'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['剛毅艾奈絲'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['魔弓恩奈雅'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    ...
    OP_38(ChrTable['蓋烏斯'], 0x00, 0x00, 'AniSetWorkWait')
    SetChrAni(ChrTable['蓋烏斯'], 0x00, 'AniWait', 0.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['蓋烏斯'], 0x00, 'AniEvWait', 0.000000, 1.000000, 0x00000000)
    Fade(0xFF, 0, 0x0000)
    ...
    OP_26()
    SetChrAni(ChrTable['米莉亞姆'], 0x00, 'AniEvRyoteGyu', -1.000000, 1.000000, 0x00000000)
    SetChrAni(ChrTable['尤西斯'], 0x00, 'AniEvGyu', -1.000000, 1.000000, 0x00000000)
    ...
    SetChrAni(ChrTable['黎恩'], 0x00, 'AniEv00025', 1.000000, 1.000000, 0x00000000)
    ...
    OP_46(0x00, ChrTable['亞修'], ChrTable['黎恩'], 0x0000)
    OP_46(0x00, ChrTable['妙婕'], ChrTable['黎恩'], 0x0000)
    SetChrAni(ChrTable['庫爾特'], 0x00, 'AniEvPhoneTalk', -1.000000, 1.000000, 0x00000001)
    SetChrAni(ChrTable['亞爾緹娜'], 0x00, 'AniEvPhoneLook', -1.000000, 1.000000, 0x00000001)
    SetChrAni(ChrTable['悠娜'], 0x00, 'AniEvPhoneTalk', -1.000000, 1.200000, 0x00000000)
    Fade(0xFF, 0, 0x0000)
    OP_16(0x0708)
