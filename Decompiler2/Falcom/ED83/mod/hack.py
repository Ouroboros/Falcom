...
def hack_debug_map():
    if 1:
        ...
        ChrAnimeClipCmd(0x0A, chrid, '', '')
        # ChrAnimeClipCmd(0x0A, chrid, 'C_CHR033', '')
        # OP_C6(0x05, 0x0000, 0x00000064)
        # OP_C6(0x00, 0x00)
        # OP_C6(0x01)
        # SaveClearData()
        # ReturnToTitle()
    ...
    if True:
        SetScenaFlags(ScenaFlag(0x016F, 7))
        SetScenaFlags(ScenaFlag(0x016F, 6))
        SetScenaFlags(ScenaFlag(0x016F, 5))
        SetScenaFlags(ScenaFlag(0x016F, 4))
        SetScenaFlags(ScenaFlag(0x016F, 3))
        SetScenaFlags(ScenaFlag(0x016F, 2))
        SetScenaFlags(ScenaFlag(0x016F, 1))
        SetScenaFlags(ScenaFlag(0x016F, 0))
        SetScenaFlags(ScenaFlag(0x016E, 7))
        SetScenaFlags(ScenaFlag(0x016E, 6))
        SetScenaFlags(ScenaFlag(0x016E, 5))
        SetScenaFlags(ScenaFlag(0x016E, 4))
        SetScenaFlags(ScenaFlag(0x016E, 3))
        SetScenaFlags(ScenaFlag(0x018E, 2))
        SetScenaFlags(ScenaFlag(0x018E, 1))
        SetScenaFlags(ScenaFlag(0x016E, 2))
        SetScenaFlags(ScenaFlag(0x016E, 1))
        SetScenaFlags(ScenaFlag(0x016E, 0))
        SetScenaFlags(ScenaFlag(0x016D, 7))
        SetScenaFlags(ScenaFlag(0x016D, 6))
        SetScenaFlags(ScenaFlag(0x016D, 5))
        SetScenaFlags(ScenaFlag(0x016D, 4))
        SetScenaFlags(ScenaFlag(0x018E, 6))
        SetScenaFlags(ScenaFlag(0x016D, 3))
        SetScenaFlags(ScenaFlag(0x016D, 2))
        SetScenaFlags(ScenaFlag(0x016D, 1))
        SetScenaFlags(ScenaFlag(0x016D, 0))
        SetScenaFlags(ScenaFlag(0x016C, 7))
        SetScenaFlags(ScenaFlag(0x016C, 6))
        SetScenaFlags(ScenaFlag(0x016C, 5))
        SetScenaFlags(ScenaFlag(0x016C, 4))
        SetScenaFlags(ScenaFlag(0x016C, 3))
        SetScenaFlags(ScenaFlag(0x016C, 2))
        SetScenaFlags(ScenaFlag(0x0072, 4))
        SetScenaFlags(ScenaFlag(0x016C, 1))
        SetScenaFlags(ScenaFlag(0x016C, 0))
        SetScenaFlags(ScenaFlag(0x016B, 7))
        SetScenaFlags(ScenaFlag(0x016B, 6))
        SetScenaFlags(ScenaFlag(0x016B, 5))
        SetScenaFlags(ScenaFlag(0x016B, 4))
        SetScenaFlags(ScenaFlag(0x016B, 4))
        SetScenaFlags(ScenaFlag(0x016B, 2))
        SetScenaFlags(ScenaFlag(0x016B, 1))
        SetScenaFlags(ScenaFlag(0x016B, 0))
        SetScenaFlags(ScenaFlag(0x016A, 7))
        SetScenaFlags(ScenaFlag(0x016A, 6))
        SetScenaFlags(ScenaFlag(0x016A, 5))
        SetScenaFlags(ScenaFlag(0x016A, 4))

    OP_AC(0x01, 0x00003123)
    OP_14(0x04000000)

def hack_EV_03_81_01():
    ...
    EffectCmd(0x0A, 0xFFFF, 0xC8, 'event/evmm30_00.eff')
    EffectCmd(0x0A, 0xFFFF, 0xC9, 'event/evbom010.eff')
    EffectCmd(0x0A, 0xFFFF, 0xCA, 'event/evret_01.eff')
    EffectCmd(0x0A, 0xFFFF, 0xCB, 'event/evr22_00.eff')
    EffectCmd(0x0A, 0xFFFF, 0xCC, 'event/evr22_01.eff')
    ...
    OP_16(0x0000)
    ChrAnimeClipCmd(0x08, ChrTable['黎恩'], 0x00, 'AniEvDead1', 'AniEv00025', 'AniEvSquat', 'AniEv00024', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['尤西斯'], 0x00, 'AniEvDead1', 'AniEvSquat', 'AniEvGyu', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['米莉亞姆'], 0x00, 'AniEvDead1', 'AniEvSquat', 'AniEvRyoteGyu', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['蓋烏斯'], 0x00, 'AniEvDead1', 'AniEvSquat', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['莎拉'], 0x00, 'AniEvDead1', 'AniEvSquat', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['奧蕾莉亞分校長'], 0x00, 'AniEvDead1', 'AniEvWeak', 'AniEvBtlWait', 'AniEvFieldAttackEnd', 'AniEv34085', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['悠娜'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['庫爾特'], 0x00, 'AniEvOdoroki', 'AniEvPhoneTalk', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['亞爾緹娜'], 0x00, 'AniEvTeMune', 'AniEvPhoneLook', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['鋼之雅里安洛德'], 0x00, 'AniEvDead1', 'AniEv32030', 'AniEvPhoneHold', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['神速杜巴莉'], 0x00, 'AniEvDead1', 'AniEvSquat', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['魔弓恩奈雅'], 0x00, 'AniEvDead1', 'AniEvSquat', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['剛毅艾奈絲'], 0x00, 'AniEvDead1', 'AniEvSquat', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    ChrAnimeClipCmd(0x08, ChrTable['永世α'], 0x00, 'AniEvk1023', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')
    OP_11(0x05D1)
    ...
    EffectCmd(0x0C, 0xFFFF, (0xFF, 0xC8, 0x0), 0xFFFF, 0x00000000, (0xDD, ''), (0xEE, -46.900001525878906, 0x0), (0xEE, 114.05999755859375, 0x0), (0xEE, -0.7400000095367432, 0x0), 0.000000, 0.000000, 0.000000, (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), 0xFF)
    OP_68(0x01, 'm30evt00', 0x0001)
    OP_68(0x01, 'm30evt00', 0x0002)
    OP_68(0x00, 'm30evt00', 0x0004)
    CameraCmd(0x02, 0x03, -38.450001, 116.820000, -2.220000, 0)
    CameraCmd(0x04, 0x03, 351.000000, 99.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 4.300000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    OP_7E(0x00)
    OP_7E(0x02, 0x0001)
    ...
    CameraCmd(0x02, 0x03, -34.220001, 114.919998, -2.240000, 6000)
    CameraCmd(0x04, 0x03, 357.000000, 104.000000, 354.000000, 6000, 0x01)
    CameraCmd(0x05, 0x03, 4.300000, 6000)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x02, 0x03, -38.709999, 115.269997, -1.960000, 0)
    CameraCmd(0x04, 0x03, 17.000000, 232.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.100000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    OP_7E(0x00)
    OP_7E(0x02, 0x0001)
    OP_7E(0x05, 50.000000)
    OP_7E(0x06, 0x0001)
    CameraCmd(0x02, 0x03, -36.750000, 114.870003, -1.500000, 12000)
    CameraCmd(0x04, 0x03, 10.000000, 232.000000, 0.000000, 12000, 0x01)
    CameraCmd(0x05, 0x03, 1.600000, 12000)
    Fade(0xFF, 0, 0x0000)
    OP_16(0x05DC)
    ...
    # CameraCmd(0x02, 0x03, -45.279999, 104.739998, -2.270000, 0)
    CameraCmd(0x02, 0x03, -45.110001, 114.790001, -0.600000, 0)

    CameraCmd(0x04, 0x03, 8.000000, 52.000000, 352.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 2.500000, 0)
    CameraCmd(0x0B, 0x03, 32.900002, 0x0000)

    # CameraCmd(0x02, 0x03, -45.990002, 104.639999, -2.060000, 15000)
    CameraCmd(0x02, 0x03, -45.080002, 115.139999, -0.580000, 3000)

    CameraCmd(0x04, 0x03, 6.000000, 43.000000, 1.000000, 15000, 0x01)
    CameraCmd(0x05, 0x03, 2.100000, 15000)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -34.660000, 115.169998, -14.320000, 0)
    CameraCmd(0x04, 0x03, 358.000000, 351.000000, 355.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 2.300000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -34.669998, 115.250000, -14.430000, 20000)
    CameraCmd(0x04, 0x03, 356.000000, 2.000000, 355.000000, 20000, 0x01)
    CameraCmd(0x05, 0x03, 1.600000, 20000)
    ...
    CameraCmd(0x02, 0x03, -45.110001, 114.790001, -0.800000, 0)

    CameraCmd(0x04, 0x03, 13.000000, 126.000000, 3.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 2.1, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)

    CameraCmd(0x02, 0x03, -45.080002, 115.139999, -0.90000, 3000)

    CameraCmd(0x04, 0x03, 6.000000, 119.000000, 4.000000, 15000, 0x01)
    ...
    # CameraCmd(0x02, 0x03, -45.110001, 114.790001, -0.600000, 0)
    CameraCmd(0x02, 0x03, -45.080002, 115.139999, -0.580000, 0)

    CameraCmd(0x04, 0x03, 3.000000, 281.000000, 358.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 2.400000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -45.080002, 115.139999, -0.580000, 3000)
    CameraCmd(0x04, 0x03, 4.000000, 288.000000, 358.000000, 15000, 0x01)
    CameraCmd(0x05, 0x03, 2.100000, 15000)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -44.869999, 115.459999, -0.970000, 0)
    CameraCmd(0x04, 0x03, 8.000000, 61.000000, 3.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 0.900000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    OP_7E(0x00)
    OP_7E(0x02, 0x0001)
    OP_7E(0x05, 5.000000)
    OP_7E(0x06, 0x0001)
    CameraCmd(0x02, 0x03, -44.869999, 115.459999, -0.970000, 10000)
    CameraCmd(0x04, 0x03, 2.000000, 66.000000, 3.000000, 10000, 0x01)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -37.070000, 114.790001, -2.790000, 0)
    CameraCmd(0x04, 0x03, 8.000000, 308.000000, 3.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 0.900000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    OP_7E(0x00)
    OP_7E(0x02, 0x0001)
    ...
    OP_7E(0x06, 0x0001)
    CameraCmd(0x02, 0x03, -36.980000, 114.790001, -2.830000, 20000)
    CameraCmd(0x04, 0x03, 3.000000, 300.000000, 1.000000, 20000, 0x01)
    Fade(0xFF, 0, 0x0000)
    ...
    CameraCmd(0x02, 0x03, -40, 114.5, -0.5, 0)
    CameraCmd(0x04, 0x03, 11.000000, 281.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 0.9, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -39.2, 114.5, -0.7, 20000)
    CameraCmd(0x04, 0x03, 0.000000, 281.000000, 0.000000, 20000, 0x01)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -43.689999, 115.199997, -0.720000, 0)
    CameraCmd(0x04, 0x03, 354.000000, 67.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.000000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -44.369999, 115.300003, -0.820000, 15000)
    CameraCmd(0x04, 0x03, 352.000000, 72.000000, 0.000000, 15000, 0x01)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -35.849998, 115.129997, -2.410000, 0)
    CameraCmd(0x04, 0x03, 358.000000, 101.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 5.200000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x04, 0x03, 359.000000, 102.000000, 6.000000, 20000, 0x01)
    CameraCmd(0x05, 0x03, 5.700000, 1500)
    ...
    CameraCmd(0x02, 0x03, -44.689999, 115.440002, -1.250000, 0)
    CameraCmd(0x04, 0x03, 2.000000, 122.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.000000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -44.750000, 115.440002, -1.370000, 15000)
    CameraCmd(0x04, 0x03, 351.000000, 106.000000, 0.000000, 15000, 0x01)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -36.430000, 115.489998, -2.930000, 0)
    CameraCmd(0x04, 0x03, 3.000000, 240.000000, 0.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.100000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -36.430000, 115.489998, -2.930000, 6000)
    CameraCmd(0x04, 0x03, 0.000000, 243.000000, 0.000000, 6000, 0x01)
    CameraCmd(0x05, 0x03, 1.000000, 6000)
    ...
    Fade(0xFF, 0, 0x0000)
    OP_16(0x0320)
    CameraCmd(0x0A, 0.020000, 0.020000, 0.000000, 0x0064, 0x00FA, 0x0064, 0x0000, 0x0000, 0x00)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -36.380001, 115.540001, -2.640000, 0)
    CameraCmd(0x04, 0x03, 9.000000, 320.000000, 4.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.000000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -36.380001, 115.559998, -2.640000, 20000)
    CameraCmd(0x04, 0x03, 8.000000, 349.000000, 4.000000, 20000, 0x01)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -35.689999, 116.489998, -2.090000, 0)
    CameraCmd(0x04, 0x03, 355.000000, 90.000000, 6.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 5.700000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    OP_7E(0x00)
    OP_7E(0x02, 0x0001)
    OP_7E(0x05, 50.000000)
    OP_7E(0x06, 0x0001)
    CameraCmd(0x02, 0x03, -34.330002, 115.599998, -2.130000, 8000)
    CameraCmd(0x04, 0x03, 355.000000, 91.000000, 6.000000, 8000, 0x01)
    CameraCmd(0x05, 0x03, 4.800000, 8000)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -55.470001, 119.190002, -3.170000, 0)
    CameraCmd(0x04, 0x03, 6.000000, 128.000000, 3.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 9.400000, 0)
    CameraCmd(0x0B, 0x03, 34.599998, 0x0000)
    CameraCmd(0x02, 0x03, -51.950001, 117.169998, 1.360000, 6000)
    CameraCmd(0x04, 0x03, 348.000000, 56.000000, 352.000000, 6000, 0x01)
    CameraCmd(0x05, 0x03, 11.200000, 6000)
    Fade(0xFF, 0, 0x0000)
    ...
    EffectCmd(0x0C, 0xFFFF, (0xFF, 0xCC, 0x0), 0x0339, 0x00000003, (0xDD, 'NODE_HEAD'), (0xEE, 0.0, 0x0), (0xEE, 0.0, 0x0), (0xEE, 0.0, 0x0), 0.000000, 0.000000, 0.000000, (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), 0xFF)
    OP_16(0x0320)
    ...
    EffectCmd(0x0C, 0x0339, (0xFF, 0xCB, 0x0), 0x0339, 0x00000003, (0xDD, ''), (0xEE, 0.0, 0x0), (0xEE, 0.0, 0x0), (0xEE, 0.0, 0x0), 0.000000, 0.000000, 0.000000, (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), (0xEE, 1.0, 0x0), 0x67)
    CameraCmd(0x07, 0x00BF)
    OP_16(0x01F4)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -35.750000, 115.389999, -2.780000, 0)
    CameraCmd(0x04, 0x03, 3.000000, 312.000000, 13.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.700000, 0)
    CameraCmd(0x0B, 0x03, 34.000000, 0x0000)
    Fade(0xFF, 0, 0x0000)
    OP_23(0x01, 0x0258, 0x0357, 0x05, 0x0D)
    Fade(0x06, 300)
    OP_AC(0x09, 0x0001)
    ...
    OP_16(0x05DC)
    CameraCmd(0x09, 0.050000, 0.050000, 0.200000)
    SetChrAniFunction(ChrTable['黎恩'], 0x00, 'AniEv00025', 1.000000, 1.000000, 0x00000000)
    CameraCmd(0x02, 0x03, -35.980000, 115.650002, -2.700000, 1200)
    CameraCmd(0x04, 0x03, 28.000000, 270.000000, 350.000000, 1200, 0x01)
    CameraCmd(0x05, 0x03, 1.500000, 1200)
    CameraCmd(0x0B, 0x03, 34.000000, 0x04B0)
    OP_26()
    OP_63(0xFFFF, 0x01)
    CameraCmd(0x07, 0x00BF)
    Fade(0x65, 500, 1.000000, 0x0000)
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -35.810001, 115.339996, -10.210000, 0)
    CameraCmd(0x04, 0x03, 9.000000, 19.000000, 6.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.600000, 0)
    CameraCmd(0x0B, 0x03, 34.000000, 0x0000)
    CameraCmd(0x02, 0x03, -35.799999, 115.279999, -10.430000, 15000)
    CameraCmd(0x04, 0x03, 359.000000, 28.000000, 6.000000, 15000, 0x01)
    SetChrPos(ChrTable['悠娜'], -35.889999, 114.000000, -10.700000, 355.200012)
    ...
    Fade(0xFE, 0)
    CameraCmd(0x00)
    CameraCmd(0x02, 0x03, -34.560001, 115.330002, -11.900000, 0)
    CameraCmd(0x04, 0x03, 7.000000, 247.000000, 5.000000, 0, 0x01)
    CameraCmd(0x05, 0x03, 1.700000, 0)
    CameraCmd(0x0B, 0x03, 34.000000, 0x0000)
    CameraCmd(0x02, 0x03, -34.560001, 115.400002, -11.900000, 6000)
    CameraCmd(0x04, 0x03, 10.000000, 253.000000, 5.000000, 6000, 0x01)
    Fade(0xFF, 0, 0x0000)
    OP_16(0x01F4)
