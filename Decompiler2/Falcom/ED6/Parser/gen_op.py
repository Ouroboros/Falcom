...
def map_operand_type(t: OperandType) -> str:
    return {
        ...
        ED6.ED6OperandType.DATFile    : 'uint32 | str',
        ED6.ED6OperandType.Function   : 'uint16',
        ED6.ED6OperandType.Expression : 'tuple | list',
    }[t]
...
def main():
    ...
    for desc in sorted(ED6.ScenaOpTable, key = lambda desc: desc.opcode):
