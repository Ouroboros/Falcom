...
; Char chip pattern info  CH_Index, CH_DAT_Index, CP_Index, CP_DAT_Index
 ...
 (0x0084:s, 0x0038:s, 0x0094:s, 0x0038:s)
[FF FF FF FF]
...
#CraftOffsetTable
 ...
 (SysCraft_Stun:s)
 (SysCraft_Stand:s)
 (SysCraft_Dead:s) (SysCraft_Dead:s) (Craft_0F:s) (Craft_10:s) (SysCraft_MagicChant:s)
 (Craft_12:s) (Craft_13:s) (Craft_14:s) (SysCraft_MagicCast:s) (Craft_16:s)
 (Craft_17:s) (Craft_18:s) (Craft_19:s) (Craft_1A:s) (Craft_1B:s)
 (Craft_1C:s) (Craft_1D:s) (Craft_1E:s)
#CraftOffsetTableEnd
...
@_MOD 16
#Craft_0F
OP_8D(0x9:b, 0x8:i, 0x370623:i, 0x0:i, 0x0:i)
...
Call(loc_2320:s)
Call(loc_0B40:s)
OP_8D(0x15:b, Target:i, 0x400:i, 0x1E:i, 0x1:i)
Damage(Target)
OP_8D(0x16:b, Target:i, 0x400:i, 0x0:i, 0x0:i)
...
Update
Call(loc_0B40:s)
OP_8D(0x15:b, Target:i, 0x400:i, 0x23:i, 0x1:i)
Call(loc_2320:s)
BeginThread(Self, Thread1, loc_0990:s, 0x0:b)
SubChip(Self, 0x6:b)
Sleep(0x10:i)
...
Update
Call(loc_0B40:s)
OP_8D(0x15:b, Target:i, 0x400:i, 0x28:i, 0x1:i)
Call(loc_2320:s)
BeginThread(Self, Thread1, loc_0990:s, 0x0:b)
SubChip(Self, 0x6:b)
Sleep(0x10:i)
...
Voice(0x7A1:s)
Voice(0x7AB:s)
ShowEff(0x1:b, 0xFF:b, Target, 0x1:s, 0x0:i, 0x32:i, 0x0:i, 0x0:s, 0x0:s, 0x0:s, 0xFFFF:s, 0xFFFF:s, 0xFFFF:s, 0xFF:b)
Sleep(0x28:i)
Update
Call(loc_0B40:s)
OP_8D(0x15:b, Target:i, 0x400:i, 0x2D:i, 0x1:i)
Call(loc_2320:s)
SubChip(Self, 0x6:b)
Sleep(0x12C:i)
Update
