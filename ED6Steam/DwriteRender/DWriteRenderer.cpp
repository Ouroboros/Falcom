...
VOID DWriteRenderer::SaveToBmpFile()
{
...
NTSTATUS DWriteRenderer::Initialize(PCWSTR FontPath, PCWSTR FaceName, ULONG_PTR FontSize)
{
    NTSTATUS                hr;
    UINT16                  glyphIndice;
    UINT32                  codePoint;
...
NTSTATUS DWriteRenderer::DrawRenderTarget(UINT16 glyphIndice, PRECT blackBox)
{
